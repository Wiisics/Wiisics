...
public class Dialog_Calibrating extends JDialog {
    public Dialog_Calibrating(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText(WiisicsHandler.RESOURCE_BUNDLE.getString("calibrating"));
